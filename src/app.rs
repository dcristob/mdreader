...
impl eframe::App for MdReaderApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        // Unified toolbar area - always reserves space to prevent content jumping
        ...
        egui::TopBottomPanel::top("toolbar_container")
            .exact_height(toolbar_height)
            .show(ctx, |ui| {
                if opacity > 0.01 {
                    let bg_color = if self.theme == Theme::Dark {
                        egui::Color32::from_rgba_premultiplied(35, 35, 35, (opacity * 240.0) as u8)
                    } else {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if self.show_search {
                            ...
                            // Search navigation buttons in a group
                            ui.group(|ui| {
                                ui.horizontal(|ui| {
                            ...
                            // Toolbar Mode with proper button groups
